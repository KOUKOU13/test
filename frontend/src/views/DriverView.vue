...
<template>
    <main>
        ...
        <div v-if="loggedIn">
            ...
            <h2 class="font-bold">Rider stuff</h2>
            <div class="w-full">
            ...
            <DriverViewRides :isDriver="false" :key="updateViewRidesKey" :ridesShown="selectedTab" @updateRides="updateViewRidesKey++" />
            <br>
            <h2 class="font-bold">Driver stuff</h2>
            <br>
            <div class="w-full">
                <nav class="border-b text-sm flex justify-center">
                    <a class="inline-block px-4 py-2 text-gray-700 hover:text-black" :class="{'border-b-2 border-indigo-600 text-indigo-600 font-semibold': selectedTab=='upcoming'}" @click="selectedTab='upcoming'" href="#">Upcoming rides</a>
            ...
            <DriverViewRides :isDriver="true" :key="updateViewRidesKey" :ridesShown="selectedTab" @updateRides="updateViewRidesKey++" />
        </div>
        <div v-else>
